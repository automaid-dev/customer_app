...
class CustomerRepository {
  ...
  Future<Map<String, dynamic>> schedule({
    ...
    required String pickupPhotoPath,
    ...
    // validation), so this can no longer be sent as plain JSON.
    ...
    final json = await _api.post(ApiEndpoints.customerBookingSchedule, data: formData);
