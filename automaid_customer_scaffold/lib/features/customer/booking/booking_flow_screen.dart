...
class _BookingFlowScreenState extends ConsumerState<BookingFlowScreen> {
  ...
  // Fetched once on load, purely for display (the fee that's actually
  // charged/submitted still goes through bookingDraftProvider's own
  // toggleInsurance, which re-fetches defensively — this local copy is
  // just so the step can show "RM2 for up to RM200 coverage" before the
  // person has ticked anything).
  ...
  Future<void> _loadInsuranceInfo() async {
    try {
      ...
      // Non-fatal — the step just won't show fee/coverage figures if
      // this fails; insurance stays optional either way.
    }
  }
        ...
        steps: [
          ...
          Step(
            ...
            content: CheckboxListTile(
              ...
              onChanged: (checked) =>
                  ref.read(bookingDraftProvider.notifier).toggleInsurance(checked ?? false),
